...
export default function custon404() {
  ...
  return (
    <div id='message' style={main404}>
      <svg xmlns="http://www.w3.org/2000/svg" style={style404} enableBackground="new 0 0 300 225" viewBox="0 0 300 225" >
        <path fill="#e6edf9"
          ...
          className="colore6edf9 svgShape"></path>
        <ellipse cx="150" cy="189" fill="#e6edf9" rx="113.8" ry="15.3" className="colore6edf9 svgShape"></ellipse>
        <circle cx="70" cy="139.9" r="12.1" fill="#f15a24" className="colorf15a24 svgShape"></circle>
        <line x1="64" x2="76" y1="133.9" y2="145.9" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <line x1="76" x2="64" y1="133.9" y2="145.9" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <circle cx="57.7" cy="63.7" r="8.3" fill="#ffba00" className="colorffba00 svgShape"></circle>
        <line x1="53.6" x2="61.8" y1="59.6" y2="67.8" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <line x1="61.8" x2="53.6" y1="59.6" y2="67.8" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <circle cx="206.9" cy="44.6" r="4.9" fill="#07beb8" className="color07beb8 svgShape"></circle>
        <line x1="204.4" x2="209.3" y1="42.2" y2="47" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <line x1="209.3" x2="204.4" y1="42.2" y2="47" fill="none" stroke="#fff" strokeLinecap="round"
          strokeMiterlimit="10" strokeWidth=".291" className="colorStrokefff svgStroke"></line>
        <path fill="#3376dd"
          ...
          className="color3376dd svgShape"></path>
        <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
        ...
        <g fill="#000000" className="color000 svgShape">
          <path fill="#fb9a78"
            ...
            className="colorfb9a78 svgShape"></path>
          <path fill="#ff7300"
            ...
            className="colorff7300 svgShape"></path>
          <line x1="159.6" x2="244.6" y1="125.9" y2="125.9" fill="none" stroke="#000" strokeLinecap="round"
            strokeMiterlimit="10" strokeWidth=".291" className="colorStroke000 svgStroke"></line>
          <path fill="#9c1e12"
          ...
          <path fill="#007ffa"
            ...
            className="color007ffa svgShape"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M183.7,166.7c0,0,0.4-6.8-0.1-8.9s-1-8,2.2-11.6" className="colorStroke000 svgStroke"></path>
          <path fill="#fb9a78" d="M198,117.7h8.7v15.1c0,1.2-0.8,2.1-2,2.1h-4.5c-1.2,0-2.2-0.9-2.2-2.1V117.7z"
            className="colorfb9a78 svgShape"></path>
          <path fill="#f9744b" d="M203.3,123.2H198v5.8h2.8c1.5,0,2.5-1.1,2.5-2.5V123.2z" className="colorf9744b svgShape">
          </path>
          <path fill="#fb9a78"
            d="M196,109.8c-1,0-1.8,0.8-1.8,1.8l-0.4,10c-0.1,2.4,2,4.2,4.3,3.7l8.3-1.6v-13.9L196,109.8    z"
            className="colorfb9a78 svgShape"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M199.2 113.3c0 0 2-.1 3.7 1.3M197.4 113.3c0 0-1.6.1-2.7.9" className="colorStroke000 svgStroke"></path>
          <ellipse cx="195.5" cy="116.5" fill="#3376dd" rx=".5" ry=".7" className="color3376dd svgShape"></ellipse>
          <ellipse cx="200.7" cy="116.5" fill="#3376dd" rx=".5" ry=".7" className="color3376dd svgShape"></ellipse>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M197.5 116.4l-1.3 2.2c-.2.3 0 .7.4.7h.5M199.2 121c0 0-1.7.3-3.1-.2" className="colorStroke000 svgStroke">
          </path>
          <path fill="#9c1e12"
          ...
          <line x1="209.2" x2="210.9" y1="165.9" y2="167.7" fill="none" stroke="#000" strokeLinecap="round"
            strokeMiterlimit="10" strokeWidth=".291" className="colorStroke000 svgStroke"></line>
          <polyline fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
          ...
          <ellipse cx="207" cy="117.4" fill="#fb9a78" rx="2.6" ry="2.1" transform="rotate(-45.001 206.956 117.404)"
            className="colorfb9a78 svgShape"></ellipse>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M207.9,118.7c0.8-0.8,0.9-1.9,0.2-2.5s-1.8-0.5-2.5,0.2" className="colorStroke000 svgStroke"></path>
          <circle cx="205.8" cy="119.8" r=".5" fill="#ffffff" className="colorfff svgShape"></circle>
          <g fill="#000000" className="color000 svgShape">
            <path fill="#fb9a78"
          ...
          <g fill="#000000" className="color000 svgShape">
            <line x1="236" x2="240.6" y1="118.8" y2="123.4" fill="none" stroke="#000" strokeLinecap="round"
              strokeMiterlimit="10" strokeWidth=".291" className="colorStroke000 svgStroke"></line>
            <line x1="240.6" x2="236" y1="118.8" y2="123.4" fill="none" stroke="#000" strokeLinecap="round"
              strokeMiterlimit="10" strokeWidth=".291" className="colorStroke000 svgStroke"></line>
          </g>
          <g fill="#000000" className="color000 svgShape">
            <circle cx="139.1" cy="111.6" r="13" fill="#ffffff" opacity=".5" className="colorfff svgShape"></circle>
            <path fill="#f15a24"
              ...
              className="colorf15a24 svgShape"></path>
            <path fill="#f15a24"
            ...
            <rect width="3.2" height="2" x="134.5" y="128.1" fill="#ff7300" transform="rotate(9.495 136.107 129.132)"
              className="colorff7300 svgShape"></rect>
            <path fill="#ffba00"
              ...
              className="colorffba00 svgShape"></path>
            <path fill="none" stroke="#fff" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
              d="M140.9,101c5.8,1,9.8,6.5,8.8,12.3" className="colorStrokefff svgStroke"></path>
          </g>
          <path fill="#fb9a78"
          ...
          <path fill="#fb9a78"
            ...
            className="colorfb9a78 svgShape"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M132.2,136l2.7,1.2c0.8,0.4,0.4,1.5-0.5,1.4l-2.4-0.5" className="colorStroke000 svgStroke"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            ...
            className="colorStroke000 svgStroke"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M135.7,141.5l-2-0.9c-0.2-0.1-0.4-0.1-0.6-0.2l-1.1-0.2" className="colorStroke000 svgStroke"></path>
          <path fill="#fb9a78"
            d="M132.6,133.9l2.7,1.2c0.8,0.4,0.4,1.5-0.5,1.4l-2.4-0.5c-0.7-0.1-1.1-0.7-1-1.4l0-0.1    C131.5,134,132.1,133.6,132.6,133.9z"
            className="colorfb9a78 svgShape"></path>
          <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
            d="M132.6,133.9l2.7,1.2c0.8,0.4,0.4,1.5-0.5,1.4l-2.4-0.5" className="colorStroke000 svgStroke"></path>
          <g fill="#000000" className="color000 svgShape">
            <path fill="#fb9a78"
              ...
              className="colorfb9a78 svgShape"></path>
            <path fill="none" stroke="#000" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
              d="M137.4,138.7l-2.4-2.9l-2.8-1.2c-0.5-0.2-0.3-0.9,0.2-0.9l2.4-0.1" className="colorStroke000 svgStroke"></path>
          </g>
        </g>
        <g fill="#000000" className="color000 svgShape">
          <ellipse cx="236.8" cy="83.9" fill="#007ffa" rx="13.5" ry="11.2" className="color007ffa svgShape"></ellipse>
          <path fill="#ffba00"
            ...
            className="colorffba00 svgShape"></path>
          <polygon fill="#007ffa" points="233.8 93.4 228.5 97.3 229.3 91.5" className="color007ffa svgShape"></polygon>
        </g>
        <g fill="#000000" className="color000 svgShape">
          <Link href="/Resume">
            <path fill="#07beb8"
              ...
              className="color07beb8 svgShape"></path>
            ...
            <path fill="none" stroke="#fff" strokeLinecap="round" strokeMiterlimit="10" strokeWidth=".291"
              d="M79.6,182.7l-2.2-2.2c-0.5-0.5-0.5-1.4,0-1.9l2.2-2.2" className="colorStrokefff svgStroke"></path>
            <circle cx="78.5" cy="179.6" r="4.9" fill="none" stroke="#fff" strokeLinecap="round" strokeMiterlimit="10"
              strokeWidth=".291" className="colorStrokefff svgStroke"></circle></Link>
        </g>
      </svg>
    </div>
  );
